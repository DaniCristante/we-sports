...
<div id="userUpdateForm">
    <form action="{{route('register')}}" class="form-group form  col-12 my-2 mx-1 p-4" method="POST">
        @csrf
        ...
        <div class="form-group">
            <label>Nombre</label>
            <input type="text" class="form-control" readonly name="uname" value="{{$data['uname']}}">
        </div>
